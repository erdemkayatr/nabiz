...
const STRINGS = {
  tr: {
    ...
    "diag.stale": "yanıt vermiyor",
    "diag.capturing": "alınıyor", "diag.stop": "Durdur", "diag.stopping": "durduruluyor…",
    "diag.cancelled": "durduruldu", "diag.runInBackground": "Arka planda devam etsin",
    "diag.cpuInterruptible": "Durdurursanız o ana kadarki örnekler geçerli bir profil olarak kaydedilir.",
    "diag.memoryNotInterruptible": "Bellek dump'ı başladıktan sonra kesilemez: runtime süreci askıya alıp dosyayı yazıyor. Başladıysa bitmesini beklemek gerekir.",
    "diag.stoppedPartial": "Durduruldu. O ana kadar toplanan profil alınıyor…",
    "diag.fileCount": "dosya", "diag.retention": "saklama", "diag.days": "gün",
  ...
  en: {
    ...
    "diag.stale": "not responding",
    "diag.capturing": "capturing", "diag.stop": "Stop", "diag.stopping": "stopping…",
    "diag.cancelled": "stopped", "diag.runInBackground": "Keep running in background",
    "diag.cpuInterruptible": "If you stop it, the samples collected so far are kept as a valid profile.",
    "diag.memoryNotInterruptible": "A memory dump cannot be interrupted once started: the runtime suspends the process and writes the file. Once it begins it has to run to completion.",
    "diag.stoppedPartial": "Stopped. Collecting the profile gathered so far…",
    "diag.fileCount": "files", "diag.retention": "retention", "diag.days": "days",
